...
[ -z "$REPO_URI" ] && REPO_URI='https://github.com/o-scripts/spf13-vim.git'
[ -z "$REPO_BRANCH" ] && REPO_BRANCH='3.0'
debug_mode='0'
fork_maintainer='0'
[ -z "$VUNDLE_URI" ] && VUNDLE_URI="https://github.com/o-scripts/Vundle.vim.git"
...
create_symlinks() {
    ...
    lnif "$source_path/bundle"           "$target_path/.vim/bundle"
